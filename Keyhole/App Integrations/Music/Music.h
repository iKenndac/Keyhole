...
// NOTE: This was autogenerated from the Music app's .sdef with `sdp`. It isn't used by the project
// directly, but instead as a reference to manually build MusicAppSwiftScriptingBridge.swift.
