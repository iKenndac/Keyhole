...
// NOTE: This was autogenerated from Doppler's .sdef with `sdp`. It isn't used by the project
// directly, but instead as a reference to manually build DopplerSwiftScriptingBridge.swift.
...
- (SBElementArray<DopplerTrack *> *) tracks;
...
- (void) playpause;  // toggle the playing/paused state of the current track in the playback queue
