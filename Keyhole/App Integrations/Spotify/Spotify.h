...
// NOTE: This was autogenerated from the Spotify app's .sdef with `sdp`. It isn't used by the project
// directly, but instead as a reference to manually build SpotifySwiftScriptingBridge.swift.
